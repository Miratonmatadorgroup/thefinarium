...
const RoundArrowButton = ({title,text,size}) => {
    return (
        <div className="w-fit hover:scale-105 transition duration-500 ease-in-out cursor-pointer flex  items-center gap-3 pl-3 py-0.5 rounded-full border border-[#cc5802]">
